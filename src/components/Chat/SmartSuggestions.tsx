    ...
    () => [
      {
        ...
        action: () =>
          prepareTemplate({
            ...
            systemPrompt:
              'Tu es un expert en rédaction. Améliore le texte suivant en gardant le sens original mais en rendant le style plus fluide, clair et engageant.',
      ...
      },
      {
        ...
        action: () =>
          prepareTemplate({
            ...
            systemPrompt:
              'Tu es un excellent pédagogue. Explique des concepts complexes de manière simple et accessible, avec des exemples concrets.',
      ...
      },
      {
        ...
        action: () =>
          prepareTemplate({
            ...
            systemPrompt:
              'Tu es un expert en créativité et innovation. Génère des idées originales et pratiques pour résoudre des problèmes ou explorer de nouvelles opportunités.',
  ...
  return (
    <div className="smart-suggestions">
      ...
      <div className="smart-suggestions-header">
        ...
        <div className="smart-suggestions-subtitle">Basées sur votre conversation</div>
      </div>
